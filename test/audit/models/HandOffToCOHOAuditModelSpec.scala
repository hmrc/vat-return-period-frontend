...
class HandOffToCOHOAuditModelSpec extends BaseSpec {

  val transactionName: String = "handoff-to-companies-house"
  val auditType: String = "StartChangeBusinessName"

  val organistationname: String = "testName"

  lazy val agentHandOff = HandOffToCOHOAuditModel(agentUser, organistationname)
  lazy val userHandOff = HandOffToCOHOAuditModel(user, organistationname)
    ...
    "user is an Agent" should {
      ...
      "have the correct details for the audit event" in {
        agentHandOff.detail shouldBe Json.obj(
          ...
          "vrn" -> agentUser.vrn,
          "currentBusinessName" -> organistationname
        )
      }
    }
    ...
    "user is a non-Agent" should {
      ...
      "have the correct details for the audit event" in {
        userHandOff.detail shouldBe Json.obj(
          "isAgent" -> false,
          "vrn" -> user.vrn,
          "currentBusinessName" -> organisationJsonR8
        )
      }
    }
  }
